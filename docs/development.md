...
**Never edit `configure_packages_debian.sh` or `configure_packages_arch.sh` directly** — they carry a `# DO NOT EDIT` header and any manual changes will be overwritten on the next generation run.
